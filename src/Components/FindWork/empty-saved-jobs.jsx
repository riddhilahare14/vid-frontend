    ...
    <div className="flex flex-col items-center justify-center py-16">
      ...
      >
        ...
        <svg
          ...
          style={{ mask: 'radial-gradient(circle, transparent 50%, white 50%)' }}
        >
          <path
            d="M32 32 L232 232"
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <button className="flex items-center gap-2 rounded-full bg-blue-600 px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700">
